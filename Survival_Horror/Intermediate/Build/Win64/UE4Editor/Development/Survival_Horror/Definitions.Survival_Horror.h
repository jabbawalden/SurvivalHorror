...
#define ORIGINAL_FILE_NAME "UE4Editor-Survival_Horror.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME Survival_Horror
#define DEPRECATED_FORGAME DEPRECATED
#define SURVIVAL_HORROR_API DLLEXPORT
